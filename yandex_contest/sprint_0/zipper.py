...
def array(a, b):
    """Функция объединеия двух массивов парами в один через цикл."""
    res = []
...
"""
Функция объединеия двух массивов парами в один через функцию zip. Метод extend
позволяет объединить два списка в один путем добавления элементов в конец.
def zipper(a, b):
    answer = []
    for i in zip(a, b):
        answer.extend(i)
